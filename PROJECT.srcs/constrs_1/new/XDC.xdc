...
## Switches
set_property PACKAGE_PIN V17 [get_ports {count_limit[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {count_limit[0]}]
set_property PACKAGE_PIN V16 [get_ports {count_limit[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {count_limit[1]}]
set_property PACKAGE_PIN W16 [get_ports {count_limit[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {count_limit[2]}]
set_property PACKAGE_PIN W17 [get_ports {count_limit[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {count_limit[3]}]
...
set_property PACKAGE_PIN W3 [get_ports {led_out}]					
...
set_property PACKAGE_PIN U2 [get_ports {anode_ctrl[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anode_ctrl[0]}]
set_property PACKAGE_PIN U4 [get_ports {anode_ctrl[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anode_ctrl[1]}]
set_property PACKAGE_PIN V4 [get_ports {anode_ctrl[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {anode_ctrl[2]}]
set_property PACKAGE_PIN W4 [get_ports {anode_enable}]					
